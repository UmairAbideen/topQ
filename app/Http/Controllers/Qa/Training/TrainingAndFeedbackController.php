...
namespace App\Http\Controllers\Qa\Training;
...
class TrainingAndFeedbackController extends Controller
{
    ...
    public function triningAttendanceView()
    {
        ...
        $training = TrainingAndFeedback::where('trainer_department', $department)->get();

        return view('qa.training.attendance.view', ['training' => $training, 'username' => $userName]);
    }

    public function triningAttendanceForm()
    {
        $users = User::get();
        return view('qa.training.attendance.add', ['users' => $users]);
    }
    ...
    public function triningAttendanceEdit($id)
    {
        ...
        $users = User::get();
        $attendance = TrainingAndFeedback::find($id);
        return view('qa.training.attendance.update', ['attendance' => $attendance, 'users' => $users]);
    }
    ...
    public function TsTriningAttendanceView()
    {
        ...
        return view('qa.training.attendance.ts.view', ['training' => $training, 'username' => $userName]);
    }
    ...
    public function ScTriningAttendanceView()
    {
        ...
        return view('qa.training.attendance.sc.view', ['training' => $training, 'username' => $userName]);
    }
    ...
    public function trainingPlanView()
    {
        ...
        return view('qa.training.annual.view', ['plan' => $plan]);
    }


    public function trainingPlanForm()
    {
        return view('qa.training.annual.add');
    }
    ...
    public function trainingPlanCreate(Request $request)
    {
        ...
        $AnnualTrainingPlan = AnnualTrainingPlan::where('department', 'QA')->first();
    ...
    public function trainingPlanEdit($id)
    {
        ...
        return view('qa.training.annual.update', ['plan' => $plan]);
    }
    ...
    public function TsTrainingPlanView()
    {
        ...
        return view('qa.training.annual.ts.view', ['plan' => $plan]);
    }
    ...
    public function ScTrainingPlanView()
    {
        ...
        return view('qa.training.annual.sc.view', ['plan' => $plan]);
    }
    ...
    public function newEmployeeTrainingView()
    {
        ...
        return view('qa.training.new-employee.view', ['new' => $new]);
    }

    public function newEmployeeTrainingForm()
    {
        return view('qa.training.new-employee.add');
    }
    ...
    public function newEmployeeTrainingEdit($id)
    {
        ...
        return view('qa.training.new-employee.update', ['new' => $new]);
    }
    ...
    public function TsNewEmployeeTrainingView()
    {
        ...
        return view('qa.training.new-employee.ts.view', ['new' => $new]);
    }
    ...
    public function ScNewEmployeeTrainingView()
    {
        ...
        return view('qa.training.new-employee.sc.view', ['new' => $new]);
    }
}
