...
namespace App\Http\Controllers\director\pdf;
...
class DirectorPdfController extends Controller
{
    // Complaint
    ...
    public function printRisk($id)
    {
        ...
        $pdf = Pdf::loadView('director.risk.pdf', compact('row'));
    ...
    public function printAgenda($id)
    {
        ...
        $pdf = Pdf::loadView('director.mrm.agenda.pdf', compact('row'));
    ...
    public function printMinutes($id)
    {
        ...
        $pdf = Pdf::loadView('director.mrm.minutes.pdf', compact('row'));
    ...
    public function printCapa($id)
    {
        ...
        $pdf = Pdf::loadView('director.capa.pdf', compact('row'));
    ...
    public function printAttendance($id)
    {
        ...
        $pdf = Pdf::loadView('director.mrm.attendance.pdf', compact('row'));
    ...
    public function downloadAttendance($id)
    {
        ...
        return $pdf->download('Attendance-' . $row->agenda->meeting_no . '.pdf');
    }
    ...
    public function printTrainingPlan($id)
    {
        ...
        $pdf = Pdf::loadView('director.training.annual.pdf', compact('row'));
    ...
    public function printNewEmployeeTraining($id)
    {
        ...
        $pdf = Pdf::loadView('director.training.new-employee.pdf', compact('row'));
    ...
    public function printIaSchedule($id)
    {
        ...
        $pdf = Pdf::loadView('director.ia.schedule.pdf', compact('row'));
    ...
    public function printRecallClosure($id)
    {
        ...
        $pdf = Pdf::loadView('director.recall.closure.pdf', compact('row'));
    ...
    public function downloadRecallClosure($id)
    {
        ...
        $row = RecallClosure::where('id', $id)->get();
        $pdf = Pdf::loadView('director.recall.closure.pdf', compact('row'));
        return $pdf->download('Recall Closure Form-' . $ro->approver_signtime . '.pdf');
    }
    ...
    public function printForm($id)
    {
        ...
        $pdf = Pdf::loadView('director.ccm.pdf', compact('row'));
    ...
    public function printDeviation($id)
    {
        ...
        $pdf = Pdf::loadView('director.deviation.pdf', compact('row'));
    ...
    public function printTrainingAttendance($id)
    {
        ...
        $pdf = Pdf::loadView('director.training.attendance.pdf', compact('row'));
    ...
    public function printChange($id)
    {
        ...
        $pdf = Pdf::loadView('director.doc-control.change.pdf', compact('row'));
    ...
    public function printIssue($id)
    {
        ...
        $pdf = Pdf::loadView('director.doc-control.issue.pdf', compact('row'));
    ...
    public function printObsolescence($id)
    {
        ...
        $pdf = Pdf::loadView('director.doc-control.obsolescence.pdf', compact('row'));
