...
namespace App\Http\Controllers\officer\risk;
...
class OfficerRiskController extends Controller
{
    public function risk()
    {
        $department = Auth::user()->department;
        $risk = Risk::where('department', $department)->get();
        return view('officer.risk.view', ['risks' => $risk, 'department' => $department]);
    }

    public function riskform()
    {
        $department = Auth::user()->department;
        return view('officer.risk.add', ['department' => $department]);
    }
    ...
    public function create(Request $request)
    {
        ...
        $request->validate([
            ...
            'completion_date5' => 'nullable|date|max:255',
        ]);
        ...
        // Fetch the latest Risk and send notification to the manager
    ...
    public function edit($id)
    {
        $department = Auth::user()->department;
        $risk = Risk::find($id);
        return view('officer.risk.update', ['risk' => $risk, 'department' => $department]);
    }
