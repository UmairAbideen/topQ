                                ...
                                <tbody>
                                    @foreach ($deviations as $deviation)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($deviation->reviewer_signtime) && is_null($deviation->approver_signtime))
                                                    <a href="{{ route('director.deviation.approve', $deviation->id) }}"
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (
                                                    !is_null($deviation->confirmer_signtime) &&
                                                        is_null($deviation->closer_signtime) &&
                                                        (!is_null($deviation->required_recall) ||
                                                            !is_null($deviation->required_capa) ||
                                                            !is_null($deviation->required_ccm)))
                                                    <a href="{{ route('director.deviation.close', $deviation->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Close</a>
                                                @elseif(!is_null($deviation->closer_signtime))
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @if (!is_null($deviation->closer_signtime))
                                                        <div>
                                                            <a href="{{ route('director.deviation.download', $deviation->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.deviation.print', $deviation->id) }}"
                                                            target="_blank"
