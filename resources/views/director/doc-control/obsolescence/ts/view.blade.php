        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item"
                                    href="{{ route('director.doc-control.obsolescence.view') }}">Quality
                                    Assuarance</a></li>
                            <li><a class="dropdown-item bg-light"
                    ...
                    <!--  Option-->
                    <div class="dropdown p-2">
                        <a class="btn btn-outline-secondary btn-sm dropdown-toggle" role="button" id="dropdownMenuButton"
                            data-bs-toggle="dropdown" aria-pressed="true">
                            M.I Internal</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item bg-light"
