                    ...
                    <div class="dropdown p-2 w-100 w-sm-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.doc-control.change.view') }}">Quality Assurance</a></li>
                    ...
                    <div class="dropdown p-2 w-100 w-sm-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                            <li><a class="dropdown-item"
                                    href="{{ route('director.doc-control.issue.view') }}">Quality Assuarance</a></li>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2"
                                            class="text-center text-secondary small font-weight-bolder opacity-9">Change
                                            No.
                                        </th>
                                        <th rowspan="2"
