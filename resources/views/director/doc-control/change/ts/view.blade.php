                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.ts.doc-control.change.view') }}">Technical
                                    Service</a></li>
                                ...
                                <tbody>
                                    @foreach ($changes as $change)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($change->verifier_name) && is_null($change->approver_name))
                                                    <a href="{{ route('director.doc-control.change.approve', $change->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Approve</a>
                                                @elseif (!is_null($change->approver_name))
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($change->approver_name))
                                                        <div>
                                                            <a href="{{ route('director.doc-control.change.download', $change->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.doc-control.change.print', $change->id) }}"
                                                            target ="_blank"
