            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.doc-control.change.view') }}">Quality
                                    Assurance</a></li>
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="{{ route('director.doc-control.issue.view') }}">Quality
                                    Assuarance</a></li>
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.ts.doc-control.issue.view') }}">Technical
                                    Service</a></li>
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ route('director.ts.doc-control.obsolescence.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('director.sc.doc-control.obsolescence.view') }}">Supply
                                    Chain</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.doc-control.mi-internal.view') }}">Quality Assuarance</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('director.ts.doc-control.mi-internal.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('director.sc.doc-control.mi-internal.view') }}">Supply
                                    Chain</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($issues as $issue)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($issue->reviewer_name) && is_null($issue->approver_name))
                                                    <a href="{{ route('director.doc-control.issue.approve', $issue->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Approve</a>
                                                @elseif (!is_null($issue->approver_name))
                                                    {{ $issue->approver_name }}
                                                @else
                                                    Pending
                                                @endif
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($issue->approver_name))
                                                        <div>
                                                            <a href="{{ route('director.doc-control.issue.download', $issue->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.doc-control.issue.print', $issue->id) }}"
                                                            target ="_blank"
