        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center">
                    <div class="p-2">
                        <a href="{{ route('director.recall.view') }}" class="btn btn-outline-secondary btn-sm" role="button"
                            aria-pressed="true">
                            Information</a>
                    </div>
                    <div class="p-2">
                                ...
                                <tbody>
                                    @foreach ($closures as $closure)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($closure->reviewer_signtime) && is_null($closure->approver_signtime))
                                                    <a href="{{ route('director.closure.approve', $closure->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Approve</a>
                                                @elseif (is_null($closure->approver_signtime))
                                                    Pending
                                                @else
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="{{ route('director.closure.download', $closure->id) }}"
                                                            class="btn bg-gradient-success btn-sm mb-0 ms-1 me-1 "
                                                            role="button" aria-pressed="true">Download</a>
                                                    </div>
                                                    <div>
                                                        <a href="{{ route('director.closure.print', $closure->id) }}"
                                                            target="_blank"
