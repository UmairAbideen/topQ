                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="{{ route('director.training.attendance.view') }}">Quality
                                    Assuarance</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('director.ts.training.attendance.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item bg-light"
                                    href="{{ route('director.sc.training.attendance.view') }}">Supply
                                    Chain</a></li>
                        </ul>
                    </div>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Training Attendance - Supply Chain</h6>
                        </div>
                    </div>
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th colspan=8 class="text-center text-secondary small font-weight-bolder opacity-9">
                                            Training</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a href="{{ route('director.training.attendance.download', $item->id) }}"
                                                            class="btn bg-gradient-success btn-sm mb-0 ms-1 me-1 "
                                                            role="button" aria-pressed="true">Download</a>
                                                    </div>
                                                    <div>
                                                        <a href="{{ route('director.training.attendance.print', $item->id) }}"
                                                            target="_blank"
