                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li><a class="dropdown-item" href="{{ route('director.ts.training.plan.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item" href="{{ route('director.sc.training.plan.view') }}">Supply Chain</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li><a class="dropdown-item" href="{{ route('director.ts.training.new-employee.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item bg-light" href="{{ route('director.sc.training.new-employee.view') }}">Supply
                                    Chain</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">New Employee Training Plan - Supply Chain</h6>
                        </div>
                    </div>
