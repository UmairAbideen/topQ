            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="{{ route('director.training.new-employee.view') }}">Quality
                                    Assuarance</a></li>
                            <li><a class="dropdown-item bg-light"
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">New Employee Training Plan - Technical Service</h6>
                        </div>
                    </div>
