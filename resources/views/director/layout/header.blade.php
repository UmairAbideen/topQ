                            ...
                            <div>
                                <li class="mb-2">
                                    ...
                                    <a class="dropdown-item border-radius-md {{ $notification->read_at ? '' : 'bg-gradient-light' }}"
                                        href="{{ $notification->data['object'] === 'complaint' ? route('director.complaint.view') : route('director.risk.view') }}">
                                    ...
                                    @if (!$notification->read_at)
                                        <p
                                            ...
                                            <a class="nav-link"
                                                href="{{ route('director.complaint.read', $notification->id) }}">

                                                {{-- href="{{ $notification->data['object'] === 'complaint' ? route('director.complaint.read') : route('director.risk.read') }}"> --}}
