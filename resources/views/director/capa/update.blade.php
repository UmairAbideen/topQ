            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        ...
                        <form class='px-3' action="{{ route('qa.capa.update', $capa->id) }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    @if (($capa->department === 'QA' && !is_null($capa->description) && is_null($capa->initiator_signtime)) ||
                                            (!is_null($capa->description) && !is_null($capa->verifier_signtime) && is_null($capa->reviewer_signtime)))
                                        ...
                                        <!----- Case 2 ----->
                                    @elseif (($capa->department === 'QA' && !is_null($capa->reviewer_signtime) && is_null($capa->approver_signtime)) ||
                                            (!is_null($capa->reviewer_signtime) && !is_null($capa->action1) && is_null($capa->approver_signtime)))
                                    ...
                                    @elseif (!is_null($capa->approver_signtime) && is_null($capa->closer_signtime))
                                        ...
                                        <div class="col-md-6 px-3">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <textarea name="effectiveness" class="form-control" cols="1" rows="1">{{ old('effectiveness', $capa->effectiveness) }}</textarea>
                                                @error('effectiveness')
                                                    <div class="text-danger small">{{ $message }}</div>
                                                @enderror
                                            </div>
