                                    ...
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <select class="form-control" name="recall_type">
                                            ...
                                            <option value="Class I"
                                                {{ old('recall_type') == 'Class I' ? 'selected' : '' }}>Class I</option>
                                            <option value="Class II"
                                                {{ old('recall_type') == 'Class II' ? 'selected' : '' }}>Class II</option>
                                            <option value="Class III"
                                                {{ old('recall_type') == 'Class III' ? 'selected' : '' }}>Class III
                                            </option>
                                            <option value="Class IV"
                                                {{ old('recall_type') == 'Class IV' ? 'selected' : '' }}>Class IV</option>
                                        </select>
                                        @error('recall_type')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
