                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (is_null($change->verifier_name))
                                                    <a href="{{ route('qa.doc-control.change.verify', $change->id) }}"
                                            ...
                                            {{-- <a href="{{ route('qa.doc-control.change.approve', $change->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    @if (is_null($change->verifier_name))
                                                        <div>
                                                            <a href="{{ route('qa.doc-control.change.edit', $change->id) }}"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ route('qa.doc-control.change.delete', $change->id) }}"
