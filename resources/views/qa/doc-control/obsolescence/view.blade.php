            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('qa.doc-control.obsolescence.form') }}" class="btn bg-gradient-info"
                                ...
                                <tbody>
                                    @foreach ($obs as $ob)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($ob->verifier_name) && is_null($ob->reviewer_name))
                                                    <a href="{{ route('qa.doc-control.obsolescence.review', $ob->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Review</a>
                                                @elseif(!is_null($ob->reviewer_name))
                                                    {{ $ob->reviewer_name }}
                                                @else
                                                    Pending
                                                @endif
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($ob->approver_name))
                                                        <div>
                                                            <a href="{{ route('qa.doc-control.obsolescence.download', $ob->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('qa.doc-control.obsolescence.print', $ob->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    @if (is_null($ob->reviewer_name))
                                                        <div>
                                                            <a href="{{ route('qa.doc-control.obsolescence.edit', $ob->id) }}"
                                                        ...
                                                        <div>
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#modal-delete-{{ $ob->id }}">Delete</button>

                                                            <div class="modal fade" id="modal-delete-{{ $ob->id }}"
                                                                tabindex="-1" role="dialog"
                                                                aria-labelledby="modal-delete-{{ $ob->id }}"
                                                                aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h6 class="modal-title font-weight-normal"
                                                                                id="modal-title-default">Document
                                                                                Obsolescence
                                                                            </h6>
                                                                            <button type="button"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ route('qa.doc-control.obsolescence.delete', $ob->id) }}"
