                   ...
                   <div class="d-flex flex-wrap justify-content-center">
                    ...
                    <div class="dropdown p-2 w-100 w-sm-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                            ...
                            <li><a class="dropdown-item" href="{{ route('qa.ts.doc-control.issue.view') }}">Technical
                                    Service</a></li>
                            <li><a class="dropdown-item bg-light" href="{{ route('qa.sc.doc-control.issue.view') }}">Supply Chain</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown p-2 w-100 w-sm-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                            <li><a class="dropdown-item" href="{{ route('qa.doc-control.obsolescence.view') }}">Quality
                                    Assurance</a></li>
