        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    ...
                    <!-- Option -->
                    <div class="dropdown p-2 w-100 w-sm-auto">
                        <a class="btn bg-gradient-primary btn-sm w-100 w-sm-auto" role="button" id="dropdownMenuButton2"
                            data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('qa.doc-control.issue.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($issues as $issue)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($issue->verifier_name) && is_null($issue->reviewer_name))
                                                    <a href="{{ route('qa.doc-control.issue.review', $issue->id) }}"
                                                        class="btn bg-gradient-info btn-sm mb-0 ms-1 me-1 " role="button"
                                                        aria-pressed="true">Review</a>
                                                @elseif(!is_null($issue->reviewer_name))
                                                    {{ $issue->reviewer_name }}
                                                @else
                                                    Pending
                                                @endif
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($issue->approver_name))
                                                        <div>
                                                            <a href="{{ route('qa.doc-control.issue.download', $issue->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('qa.doc-control.issue.print', $issue->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    @if (is_null($issue->reviewer_name))
                                                        <div>
                                                            <a href="{{ route('qa.doc-control.issue.edit', $issue->id) }}"
                                                        ...
                                                        <div>
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#modal-delete-{{ $issue->id }}">Delete</button>

                                                            <div class="modal fade" id="modal-delete-{{ $issue->id }}"
                                                                tabindex="-1" role="dialog"
                                                                aria-labelledby="modal-delete-{{ $issue->id }}"
                                                                aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h6 class="modal-title font-weight-normal"
                                                                                id="modal-title-default">Document Number
                                                                                Issuance
                                                                                Deletion
                                                                            </h6>
                                                                            <button type="button"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ route('qa.doc-control.issue.delete', $issue->id) }}"
