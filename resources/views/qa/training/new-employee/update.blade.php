                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Update New Employee Training Plan </h6>
                        </div>

                        <div class="d-flex justify-content-end pe-0 pt-4">
                            <a href="{{ route('qa.training.new-employee.view') }}" class="btn bg-gradient-info" role="button"
                        ...
                        <form class='px-3' action="{{ route('qa.training.new-employee.update', $new->id) }}"
                            method="post">
                            @csrf
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="attendee_designation" class="form-control"
                                            value="{{ $new->attendee_designation }}">
                                    ...
                                    <div class="col-md-4 px-3">
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            <input type="text" name="training_name{{ $i }}"
                                                class="form-control" value="{{ $new['training_name' . $i] ?? '' }}">
                                    ...
                                    <div class="col-md-2 px-3">
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            <input type="date" name="training_date{{ $i }}"
                                                class="form-control" value="{{ $new['training_date' . $i] ?? '' }}">
