                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            @if ($department === 'TS')
                                <li><a class="dropdown-item bg-light" href="{{ route('o.document.sop.ts.view') }}">Technical
                                        Service</a></li>
                            @elseif ($department === 'SC')
                                <li><a class="dropdown-item" href="{{ route('o.document.sop.sc.view') }}">Supply Chain</a>
                                </li>
                            @endif
                        </ul>
                    </div>
