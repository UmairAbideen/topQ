            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('officer.doc-control.change.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($change->approver_name))
                                                        <div>
                                                            <a href="{{ route('officer.doc-control.change.download', $change->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('officer.doc-control.change.print', $change->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    @if (is_null($change->verifier_name))
                                                        <div>
                                                            <a href="{{ route('officer.doc-control.change.edit', $change->id) }}"
