            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('officer.capa.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (!is_null($capa->description))
                                                    @if (is_null($capa->initiator_signtime) && $capa->department === Auth::user()->department)
                                                        <a href="{{ route('officer.capa.initiate', $capa->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($capa->closer_signtime))
                                                        <div>
                                                            <a href="{{ route('officer.capa.download', $capa->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('officer.capa.print', $capa->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    <!------ Case 1 ----->
                                                    @if (!is_null($capa->description) && is_null($capa->initiator_signtime))
                                                        <div>
                                                            <a href="{{ route('officer.capa.edit', $capa->id) }}"
