            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        ...
                        <form class='px-3' action="{{ route('officer.ccm.update', $change->id) }}" method="post">
                            @csrf
                            @if (session('status'))
                            ...
                            <div class="row">
                                ...
                                @if (!is_null($change->initiator_signtime) && !is_null($change->approver_signtime) && is_null($change->closer_signtime))
