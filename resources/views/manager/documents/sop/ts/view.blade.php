        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center">
                    <div class="p-2">
                        <a href="{{ route('m.document.policy.view') }}" class="btn btn-outline-secondary btn-sm" role="button"
                            aria-pressed="true">
                            Policy</a>
                    </div>
                    <div class="dropdown p-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            @if ($department === 'TS')
                                <li><a class="dropdown-item bg-light" href="{{ route('m.document.sop.ts.view') }}">Technical
                                        Service</a></li>
                            @elseif ($department === 'SC')
                                <li><a class="dropdown-item" href="{{ route('m.document.sop.sc.view') }}">Supply Chain</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">TS SOPs</h6>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('m.document.sop.ts.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex  justify-content-center  align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('m.document.sop.ts.edit', $sop->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('m.document.sop.ts.delete', $sop->id) }}"
                                                                            class="btn bg-gradient-danger btn-sm mb-0 ms-1 me-1"
