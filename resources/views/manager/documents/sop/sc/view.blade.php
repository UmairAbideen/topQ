            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('m.document.sop.sc.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex  justify-content-center  align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('m.document.sop.sc.edit', $sop->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('m.document.sop.sc.delete', $sop->id) }}"
                                                                            class="btn bg-gradient-danger btn-sm mb-0 ms-1 me-1"
