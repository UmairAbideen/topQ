                                        ...
                                        <tr>
                                                ...
                                                @if (!is_null($capa->initiator_signtime))
                                                    @if (is_null($capa->verifier_signtime))
                                                        @if ($capa->department === Auth::user()->department)
                                                            <a href="{{ route('manager.capa.verify', $capa->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($capa->closer_signtime))
                                                        <div>
                                                            <a href="{{ route('manager.capa.download', $capa->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('manager.capa.print', $capa->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    <!------ Case 1 ----->
                                                    @if (!is_null($capa->description) && !is_null($capa->initiator_signtime) && is_null($capa->verifier_signtime))
                                                        <div>
                                                            <a href="{{ route('manager.capa.edit', $capa->id) }}"
