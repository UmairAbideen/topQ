            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('manager.doc-control.obsolescence.form') }}" class="btn bg-gradient-info"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (is_null($ob->verifier_name))
                                                    <a href="{{ route('manager.doc-control.obsolescence.verify', $ob->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($ob->approver_name))
                                                        <div>
                                                            <a href="{{ route('manager.doc-control.obsolescence.download', $ob->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('manager.doc-control.obsolescence.print', $ob->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    @if (is_null($ob->verifier_name))
                                                        <div>
                                                            <a href="{{ route('manager.doc-control.obsolescence.edit', $ob->id) }}"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ route('manager.doc-control.obsolescence.delete', $ob->id) }}"
