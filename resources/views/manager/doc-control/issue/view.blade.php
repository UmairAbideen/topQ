            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <div class="d-flex justify-content-end pe-3 pt-4">
                        <a href="{{ route('manager.doc-control.issue.form') }}" class="btn bg-gradient-info" role="button"
                            aria-pressed="true">+
                            Add New</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if (is_null($issue->verifier_name))
                                                    <a href="{{ route('manager.doc-control.issue.verify', $issue->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    @if (!is_null($issue->approver_name))
                                                        <div>
                                                            <a href="{{ route('manager.doc-control.issue.download', $issue->id) }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('manager.doc-control.issue.print', $issue->id) }}"
                                                            target ="_blank"
                                                    ...
                                                    @if (is_null($issue->verifier_name))
                                                        <div>
                                                            <a href="{{ route('manager.doc-control.issue.edit', $issue->id) }}"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ route('manager.doc-control.issue.delete', $issue->id) }}"
